...
public class DocumentService {
    ...
    private final String FOLDER_PATH = Paths.get(System.getProperty("user.dir"), "files").toString();
    ...
    public Document uploadDocument(DocumentDto documentDto, MultipartFile file) throws IOException {
        ...
        if (result.isEmpty()) {
            String filePath = Paths.get(FOLDER_PATH, file.getOriginalFilename()).toString();
